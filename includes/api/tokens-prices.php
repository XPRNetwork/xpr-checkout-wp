...
add_action('rest_api_init', 'xprcheckout_register_tokens_prices_routes');

function xprcheckout_register_tokens_prices_routes()
{
  // register_rest_route() handles more arguments but we are going to stick to the basics for now.
  register_rest_route('xprcheckout/v1', '/tokens-prices', array(
    'methods'  => 'POST',
